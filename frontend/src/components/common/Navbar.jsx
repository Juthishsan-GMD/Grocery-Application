...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-[1000] py-5 transition-all duration-300 shadow-md ${scrolled ? '!py-3 shadow-lg bg-gradient-to-br from-[#047857] to-[#059669]' : 'bg-gradient-to-br from-[#059669] to-[#10b981]'}`}>
      <div className="container mx-auto flex justify-between items-center gap-6">
        ...
        {/* Center: Search Bar */}
        <div className="flex-1 max-w-[500px] hidden xl:block relative">
